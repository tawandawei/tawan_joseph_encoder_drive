...
#ifndef TAWAN_ENCODER_DRIVE_H
#define TAWAN_ENCODER_DRIVE_H
...
#ifdef JOSEPH
#define ENT_CNT_PER_REV 48
#define MOTOR_GEARRATIO (1/48.0f) // TS-25GA370H-10
#else
